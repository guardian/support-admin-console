...
object S3Client {
  ...
  case object S3VersionMatchError extends S3ClientError {
    override def getMessage =
      "Can't save your settings because someone else has updated them since they were last fetched"
  }
...
object S3Json extends StrictLogging {
  ...
  def getFromJson[T: Decoder](s3: S3Client): S3ObjectSettings => ZIO[Any, Throwable, VersionedS3Data[T]] = {
    objectSettings =>
