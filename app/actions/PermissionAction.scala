...
/** This class provides separate Actions for read and write endpoints. Each will first perform a google auth check, then
  * do the permissions check for the user.
  */
