...
const AccessManagementDialog = ({
  ...
  const [studentLandingPagePerm, setStudentLandingPagePerm] = useState<PermissionLevel>('None');
  ...
  useEffect(() => {
    if (user) {
      ...
      const studentLandingPagePermission = user.permissions.find(
        (p) => p.name === 'student-landing-page-tests',
      );
      ...
      setStudentLandingPagePerm(
        studentLandingPagePermission ? studentLandingPagePermission.permission : 'None',
      );
    }
  }, [user]);
  ...
  const handleSave = async () => {
    ...
    if (studentLandingPagePerm != 'None') {
      updatedPermissions.push({
        name: 'student-landing-page-tests',
        permission: studentLandingPagePerm as 'Read' | 'Write',
      });
    }
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
      ...
      <DialogContent dividers>
        ...
        <FormControl component="fieldset" className={classes.formControl} fullWidth>
          <FormLabel component="legend">Student Landing Page Tests</FormLabel>
          <RadioGroup
            value={studentLandingPagePerm}
            onChange={(e) => setStudentLandingPagePerm(e.target.value as 'Read' | 'Write' | 'None')}
          >
            <FormControlLabel value="None" control={<Radio />} label="No Access" />
            <FormControlLabel value="Read" control={<Radio />} label="Read Only" />
            <FormControlLabel value="Write" control={<Radio />} label="Read & Write" />
