...
import LabelList from './test/priorityList/labelList';
import NewTestButton from './test/newTestButton';
import BatchProcessTestButton from './batchProcessTestButton';

import SidebarFilterSelector from './test/testList/sidebarFilterSelector';
    ...
    <div className={classes.root}>
      ...
      <div className={classes.listsContainer}>
        <div className={classes.priorityLabelListContainer}>
          <LabelList numTests={tests.length} />
        </div>
        <TestList
