...
interface HeadTestNewVariantButtonProps extends WithStyles<typeof styles> {
  existingNames: string[];
  createVariant: (name: string) => void;
  isDisabled: boolean;
}

const HeadTestNewVariantButton: React.FC<HeadTestNewVariantButtonProps> = ({
  classes,
  existingNames,
  createVariant,
  isDisabled,
}: HeadTestNewVariantButtonProps) => {
...
export default withStyles(styles)(HeadTestNewVariantButton);
