...
const BylineWithImageEditor: React.FC<BylineWithImageEditorProps> = ({
  ...
  return (
    <div>
      ...
      />
      <TextField
        {...register('description')} // TODO: should we remove this... nothing is happening here.
        onBlur={handleSubmit(update)}
        name="description"
      ...
      />
      <TextField
        {...register('headshot.altText',{ // TODO: note that this and the mainUrl validation methods are switched. Likely to impact existing epics
          validate: altText => {
