...
class EpicTestVariantEditor extends React.Component<Props, State> {
  ...
  onOptionalTextChange = (fieldName: string) => (
  ...
  onParagraphsChange = (fieldName: string) => (
    ...
    return (
      <div className={classes.fieldsContainer}>
        ...
        <EditableTextField
          ...
          onSubmit={this.onOptionalTextChange(
            VariantFieldNames.backgroundImageUrl
          )}
          label="Image URL"
        ...
        <div className={classes.deleteButton}>
          {this.renderDeleteVariantButton(variant.name)}
        </div>
      </div>
    );
  };
