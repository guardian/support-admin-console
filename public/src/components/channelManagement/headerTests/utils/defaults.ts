...
import { HeaderVariant, HeaderTest, MaxHeaderViews } from '../headerTestsForm';

import { getStage } from '../../../../utils/stage';

export const DEFAULT_MAX_HEADER_VIEWS: MaxHeaderViews = {
  maxViewsCount: 4,
  maxViewsDays: 30,
...
const DEV_AND_CODE_DEFAULT_TEST: HeaderTest = {
  name: 'TEST',
  nickname: 'TEST',
  isOn: false,
  locations: [],
  ...
  excludedSections: [],
  alwaysAsk: false,
  maxViews: DEFAULT_MAX_HEADER_VIEWS,
...
const PROD_DEFAULT_TEST: HeaderTest = {
  name: 'TEST',
  nickname: 'TEST',
  isOn: false,
  locations: [],
