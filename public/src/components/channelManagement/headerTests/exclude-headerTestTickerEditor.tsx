...
interface HeaderTestTickerEditorProps {
  isDisabled: boolean;
...
const HeaderTestTickerEditor: React.FC<HeaderTestTickerEditorProps> = ({
  isDisabled,
  tickerSettings,
  updateTickerSettings,
  onValidationChange,
}: HeaderTestTickerEditorProps) => {
...
export default HeaderTestTickerEditor;
