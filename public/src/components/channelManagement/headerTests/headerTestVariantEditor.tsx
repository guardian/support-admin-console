...
import { HeaderVariant, SeparateArticleCount } from './headerTestsForm';
import { Cta, SecondaryCta, HeaderEditorConfig, TickerSettings } from '../helpers/shared';
...
import HeaderTestTickerEditor from './exclude-headerTestTickerEditor';
import { EMPTY_ERROR_HELPER_TEXT, templateValidatorForPlatform } from '../helpers/validation';
import HeaderTestChoiceCardsEditor from './headerTestChoiceCardsEditor';
import HeaderTestSignInLinkEditor from './headerTestSignInLinkEditor';
...
const HeaderTestVariantEditor: React.FC<HeaderTestVariantEditorProps> = ({
  ...
  const classes = getUseStyles(headerEditorConfig.allowMultipleVariants)();

  const templateValidator = templateValidatorForPlatform(headerEditorConfig.platform);
  ...
  return (
    <div className={classes.container}>
      {headerEditorConfig.allowVariantHeader && (
        <div>
          <TextField
            inputRef={register({
              required: headerEditorConfig.requireVariantHeader ? EMPTY_ERROR_HELPER_TEXT : undefined,
      ...
      {headerEditorConfig.allowVariantHighlightedText && (
        <div>
          <TextField
            inputRef={register({
              validate: templateValidator,
      ...
      {headerEditorConfig.allowVariantImageUrl && (
        <div>
          <TextField
            inputRef={register()}
      ...
      {headerEditorConfig.allowVariantFooter && (
        <div>
          <TextField
            inputRef={register()}
      ...
      {headerEditorConfig.allowVariantCustomPrimaryCta && (
        <div className={classes.sectionContainer}>
          ...
          <HeaderTestVariantEditorCtasEditor
            ...
            supportSecondaryCta={headerEditorConfig.allowVariantCustomSecondaryCta}
          />
        </div>
      )}

      {headerEditorConfig.allowVariantSeparateArticleCount && (
        <div className={classes.sectionContainer}>
          <Typography className={classes.sectionHeader} variant="h4">
      ...
      {headerEditorConfig.allowVariantTicker && (
        <div className={classes.sectionContainer}>
          <Typography className={classes.sectionHeader} variant="h4">
            Ticker
          </Typography>

          <HeaderTestTickerEditor
      ...
      {headerEditorConfig.allowVariantChoiceCards && (
        <div className={classes.sectionContainer}>
          <Typography className={classes.sectionHeader} variant="h4">
            Choice Cards
          </Typography>

          <HeaderTestChoiceCardsEditor
      ...
      {headerEditorConfig.allowVariantSignInLink && (
        <div className={classes.sectionContainer}>
          <Typography className={classes.sectionHeader} variant="h4">
            Sign in link
          </Typography>

          <HeaderTestSignInLinkEditor
