...
const OPTIONS: OptionGroup[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'ACQUISITIONS_EMAIL', label: 'ACQUISITIONS_EMAIL' },
      ...
      { value: 'editorial', label: 'Editorial Link (editorial)' },
      { value: 'emaq', label: 'Email acquisition (emaq)' },
      { value: 'embau', label: 'Email BAU (embau)' },
      { value: 'emedt', label: 'Email Editorial (emedt)' },
      { value: 'emlf', label: 'Email inlife (emlf)' },
      { value: 'obrdg', label: 'Email onboarding (obrdg)' },
      { value: 'pgde', label: 'Email upgrade (pgde)' },
      { value: 'rnwl', label: 'Email renewal (rnwl)' },
      { value: 'stlgen', label: 'Standard Lead Gen (stlgen)' },
      { value: 'stwb', label: 'Standard Winback (stwb)' },
      { value: 'sygntd', label: 'Email system generated (sygntd)' },
      { value: 'wnbk', label: 'Email win back (wnbk)' },
    ],
  },
  {
    group: 'GUARDIAN_APP',
