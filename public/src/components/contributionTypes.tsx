...
interface ContributionTypesFormProps {
  temp?: string;
}

const ContributionTypesForm: React.FC<ContributionTypesFormProps> = ({
  temp,
}: ContributionTypesFormProps) => {
  return (
    <div>Do we still need this page?
      <span>{temp}</span> 
    </div>
  );
};

export default ContributionTypesForm;
